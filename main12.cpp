...
int main()
{
    ...
    int ich;
    cout << "Choose the type of reflection:" << endl;
    cout << "1 for reflection about x-axis" << endl;
    cout << "2 for reflection about y-axis" << endl;
    cout << "3 for reflection about origin" << endl;
    cout << "4 for reflection awbout line x=y" << endl;
    cin >> ich;
    if (ich == 1)
    {
        ...
        {
            transform(5, 5, 150, 50, 145, 170, reflect);
    ...
    else if (ich == 2)
    {
        ...
        while (!glfwWindowShouldClose(window))
        {
            transform(50, 50, 200, 50, 125, 200, reflect);
            glfwSwapBuffers(window);
            glfwPollEvents();
        }
    }
    ...
    {
        float reflect[3][3] = {{0, 1, 0}, {1, 0, 0}, {0, 0, 1}};
        while (!glfwWindowShouldClose(window))
        {
            transform(50, 50, 200, 50, 125, 200, reflect);
            glfwSwapBuffers(window);
