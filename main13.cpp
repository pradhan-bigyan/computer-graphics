...
int main()
{
    ...
    shy=0.8;
    int ich;
    cout << "Choose the type of shear:" << endl;
    cout << "1 for shear about x-axis" << endl;
    cout << "2 for shear about y-axis" << endl;
    cin >> ich;
    if (ich == 1)
    {
        float shear[3][3] = {{1, shx, 0}, {0, 1, 0}, {0, 0, 1}};
        while (!glfwWindowShouldClose(window))
        {
            transform(50, 50, 200, 50, 125, 200, shear);
    ...
    {
        float shear[3][3] = {{1, 0, 0}, {shy, 1, 0}, {0, 0, 1}};
        while (!glfwWindowShouldClose(window))
        {
            transform(50, 50, 200, 50, 125, 200, shear);
            glfwSwapBuffers(window);
